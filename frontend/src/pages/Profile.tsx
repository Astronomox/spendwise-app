...
function MenuRow({ icon, label, detail, danger = false, onClick }: MenuRowProps): React.JSX.Element {
  return (
    <motion.button
      type="button"
      whileTap={{ scale: 0.98 }}
...
export default function Profile(): React.JSX.Element {
  ...
  const [budgetValue,     setBudgetValue]     = useState(
    user?.monthlyBudget?.toString() ?? '150000'
  );
    ...
    >
      ...
      <motion.div variants={fadeUp} className="flex flex-col items-center mb-8">
        <motion.div
          ...
          className="
            ...
            bg-gradient-to-br from-rust to-rust-dim
            flex items-center justify-center
            shadow-[0_8px_40px_rgba(183,65,14,0.25)]
            mb-5
          "
        >
            ...
            {!isEditingBudget ? (
              ...
              <div className="flex items-center gap-1">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                  onClick={() => {
                    setBudgetValue(user?.monthlyBudget?.toString() ?? '150000');
                    setIsEditingBudget(false);
                  }}
      ...
      <motion.div variants={fadeUp} className="flex flex-col items-center gap-2 text-center">
        <div className="flex items-center gap-1.5 text-cream/20">
          <Info size={14} />
          <p className="text-[12px] font-medium">SpendWise v1.0.0</p>
        </div>
