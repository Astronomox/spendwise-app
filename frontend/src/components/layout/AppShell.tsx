        ...
        <aside className="hidden lg:flex fixed left-0 top-0 h-screen w-60 flex-col z-50 py-6 bg-forge-surface border-r border-white/[0.06]">
          ...
          <nav className="flex-1 flex flex-col gap-1 px-3">
            ...
            <div className="mt-6 pt-6 border-t border-white/[0.06]">
              <button
                ...
                className="w-full h-12 rounded-xl bg-rust-gradient text-white font-bold text-sm flex items-center justify-center gap-2 shadow-rust hover:shadow-rust-lg active:scale-[0.98] transition-all"
              >
          ...
          <div className="px-3">
            <div className="p-3 bg-forge-elevated rounded-2xl border border-white/[0.06] flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-rust/20 border border-rust/30 flex items-center justify-center text-[11px] font-bold text-rust flex-shrink-0">
                {initials}
              </div>
      ...
      <div className={cn('flex-1 flex flex-col w-full', !isLogger && 'lg:ml-60')}>
          ...
          <header className="lg:hidden sticky top-0 z-40 h-14 px-4 flex items-center justify-between bg-forge-bg/90 backdrop-blur-md border-b border-white/[0.06]">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="relative text-cream/55 hover:text-cream transition-colors"
        ...
        <main className="flex-1 overflow-y-auto overflow-x-hidden">
          <div className={cn(
            ...
            !isLogger && 'px-4 pb-24 lg:px-12 lg:pb-16'
          )}>
        ...
        >
          ...
          <div className="flex-1 flex justify-center">
            <button
              ...
              className="w-[52px] h-[52px] -mt-5 rounded-full bg-rust-gradient text-white flex items-center justify-center active:scale-95 transition-transform"
              style={{ boxShadow: '0 0 0 4px #0A0908, 0 4px 20px rgba(183,65,14,0.5)' }}
            >
              <Plus size={22} />
            </button>
          </div>
